...
package 
{
    ...
    public class Game extends MovieClip 
    {
        ...
        {
            var urlNotes:String;
            urlNotes = ((params.test) ? "https://www.aq.com/gamedesignnotes/AQW-Spider-OMGClient-PatchNotess-8456" : ("https://www.aq.com/gamedesignnotes/AQW-Spider-AQWClient2-PatchNotes-8484"));
        ...
        public function onBankComplete(e:Event):void
        {
            ...
            world.addItemsToBank(com.adobe.serialization.json.JSON.decode(e.target.data));
        }
        ...
        public function retrieveBook():void
        {
            ...
            loader_BoL.load(new URLRequest(((serverGamePath + "api/data/booklore?v=") + world.objInfo["sVersion"])));
        }
        ...
        public function toggleWheel():void{
            ...
            _local2 = ui.mcPopup;
            if (!isGreedyModalInStack()){
                if (_local2.currentLabel != "mcWheel"){
                    clearPopups();
                    clearPopupsQ();
                    (_local2.visible = true);
                    _local2.gotoAndPlay("Wheel");
                }
                else {
                    _local2.onClose();
                };
        ...
        public function toggleDaily():void{
            var _local2:MovieClip;
            _local2 = ui.mcPopup;
            if (!isGreedyModalInStack()){
        ...
        public function loadExternalSWF(strFilename:String):void
        {
			...
			if(world.myAvatar.objData.intAccessLevel >= 40)
				chatF.pushMsg("server", "Cutscene: https://nefilimaq.online/gamefiles/"+strFilename, "SERVER", "", 0);
